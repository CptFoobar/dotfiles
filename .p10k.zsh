# Generated by Powerlevel10k configuration wizard on 2020-01-10 at 15:24 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MODE=nerdfont-complete-complete
  ...
  POWERLEVEL9K_CUSTOM_WIFI_INFO="zsh $scripts/wifi.sh"
  POWERLEVEL9K_CUSTOM_WIFI_INFO_BACKGROUND="blue"
  POWERLEVEL9K_CUSTOM_WIFI_INFO_FOREGROUND="255"
